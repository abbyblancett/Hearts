...
public class DeckTest {
    ...
    /**
     * Test nextCard for the third card
     */
    @Test
    public void testNextCardB() {
        
        // 1. call the nextCard() method multiple times
        deck.nextCard();
        deck.nextCard();
        // 2. then test that the next nextCard() call returns the correct Card 
    ...
    /**
     * given test to iterate through initial val
     */
    @Test
    ...
    public void testGetNextB() {
        deck.nextCard();
        deck.nextCard();
        assertEquals(2, deck.getNext(), "test initial value of next");   
    }
    ...
    /**
     * Test equals with equal decks for false
     */
    ...
    public void testEqualsB() {
        ...
        Deck deck2 = new Deck();
        deck2.nextCard();
        assertFalse(deck.equals(deck2), "Test equal decks");
        
    }

    /**
     * Test equals with equal decks for false shuffle
     */
